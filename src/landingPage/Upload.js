        ...
        return( 
                ...
                <div>
                    <form method="post" action="#" id="#"  style={{height: '90%'}}>
                        <div className="form-group files"  style={{height: '100%'}}>
                            ...
                            <input type="file" className="form-control" multiple="" style={{height: '100%'}}/>
                        </div>
                    </form>
                </div>
                </Grid.Column>
            ...
            <Grid.Row columns={2} stretched style={{height: '20%', padding: '0'}}>
                <Button.Group style={{width: '100%'}}>
                    <Button onClick={this.props.modal.handleCloseModal} icon labelPosition='left'>
                        <Icon name='file outline' style={{width: '20%'}} size='large'/>
                        Open from gist
                    </Button>
                    <Button.Or />
                    <Button onClick={this.props.modal.handleCloseModal} icon labelPosition='right'>
